  ...
  <div>
    <div>
      ...
      <div class="canvas_inline canvas_margin">
        <canvas ref="result" :width="width" :height="height" />
      </div>
    </div>
    <div>
      <span>{{ nowCorner }}</span>
...
export default {
  ...
  created() {
    this.coords.push([this.baseCoord, this.baseCoord])
    this.coords.push([this.width - this.baseCoord, this.baseCoord])
    this.coords.push([this.baseCoord, this.height - this.baseCoord])
    this.coords.push([
      this.width - this.baseCoord,
      this.height - this.baseCoord,
    ])
  },
  mounted() {
    ...
    this.imageObj.src = this.captureImage
  },
  methods: {
    getNowCorner() {
    ...
    updatePerspectiveImage() {
      ...
      this.baseCanvas.draw(this.texture).perspective(before, after).update()
